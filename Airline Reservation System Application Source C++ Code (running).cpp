...
char passenger1[50], passenger2[50], passenger3[50], passenger4[50], dest[10], timee[10], coupon[15], mClass1[20], mClass2[20], mClass3[20], mClass4[20], departure, purchase, package;
...
{	rDiscount=0.0;
	...
	{	cout<<"\nTotal amount is Rs"<<fixed<<setprecision(2)<<price;
		...
		if (couponOption==1){
			...
			{	cout<<"\nEnter your coupon\n";
				cin>>coupon;
				if (strcmp(coupon, "AERO15")==0){
					cout<<"\nSuccess, 15% off applied!";
					rDiscountB=15.0/100.0*price;
					price=price-(15.0/100.0*price);
				}
				else if (strcmp(coupon, "CAPTAIN5")==0)
				{	cout<<"\nSuccess, 5% off applied!";
					rDiscountB=5.0/100.0*price;
					price=price-(5.0/100.0*price);
				}
				else if (strcmp(coupon, "COPILOT10")==0)
				{	cout<<"\nSuccess, 10% off applied!";
					rDiscountB=10.0/100.0*price;
					price=price-(10.0/100.0*price);
				}
				else if (strcmp(coupon, "STEWARD10")==0)
				{	cout<<"\nSuccess, 10% off applied!";
					rDiscountB=10.0/100.0*price;
					price=price-(10.0/100.0*price);
				}
				else if ((strcmp(coupon, "AERO15")!=0)&&(strcmp(coupon, "STEWARD10")!=0)&&(strcmp(coupon, "COPILOT10")!=0)&&(strcmp(coupon, "CAPTAIN5")!=0))
				{	do
					{	couponMenu=0;
			...
			} while ((strcmp(coupon, "AERO15")!=0)&&(strcmp(coupon, "STEWARD10")!=0)&&(strcmp(coupon, "COPILOT10")!=0)&&(strcmp(coupon, "CAPTAIN5")!=0)&&couponMenu==0);
		}
	...
	cout<<"\n\n\n___________________________________________________________________________________________\n\n       ETIHAD AIRLINE             e-Boarding Pass          [Reference Number : UITMRB370]";
	cout<<"\n__________________________________________________________________________________________\n\n      PASSENGER & FLIGHT DETAILS\n";
	cout<<"\n      "<<passenger1;
	cout<<"\n      Age "<<age1<<"        Flight  RB370               "<<mClass1;
	cout<<"\n      Seat "<<seat1;
	cout<<"\n      MUMBAI to "<<dest<<"    "<<timee<<endl;
	if (mTicket==2||mTicket==3||mTicket==4)
	{	cout<<"\n      "<<passenger2;
...
//adult-Rs1000
//kid-Rs500
/*1. Dubai (adult = adult, kid = kid / per person)
  2. Singapore (adult = +100, kid = +50 / per person)
  3. Sydney (adult = +200, kid = +100 / per person)
...
{	do
	{
		...
		{	cout<<"\n========== P A C K A G E S ==========\n\n____________________________________________________\n";
			...
			{	cin>>package;
				if (package=='A'||package=='a'){
					...
					strcpy(dest, "SYDNEY");amount=2340;rDiscountA=1260;rDest3=rDest3+4;
					voidPackages();
				}
		...
		{	a=rTicketAdult;b=rTicketKid;
			cout<<"\n\n========== E T I H A D   A I R L I N E   R E P O R T ==========";
			...
			cout<<"\n- DUBAI : "<<rDest1<<"\n- SINGAPORE : "<<rDest2<<"\n- SYDNEY  : "<<rDest3<<"\n- TOKYO   : "<<rDest4<<"\n- PARIS   : "<<rDest5<<"\n- LONDON  : "<<rDest6<<"\n- CHICAGO : "<<rDest7;
			cout<<"\n\nTotal Discount Allowed : Rs "<<rDiscount;
			cout<<"\nTotal Income           : Rs "<<fixed<<setprecision(2)<<rTotalAmount;
			rProfit=rTotalAmount-rDiscount;
			cout<<"\nNET PROFIT             : Rs "<<rProfit;
			cout<<"\n\n(Enter any key to return to Main Menu)\n";
			cin.get();cin.get();
			menu=1;
			system ("CLS");
